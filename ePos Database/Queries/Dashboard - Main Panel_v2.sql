...
SELECT C.NAME CAT_NAME, IFNULL(SUM(OD.PRICE*OD.QUANTITY),0) AMOUNT FROM ORDER_DETAILS OD
	INNER JOIN ORDERS O ON OD.ORDER_ID = O.ID
		AND O.ENDED BETWEEN '2014-11-01' AND '2014-12-12'
...
SELECT R.CODE, R.VALUE AS PAYMENT_METHOD, IFNULL(PAYMENT.AMOUNT, 0) AMOUNT FROM REF_VALUES R 
	LEFT OUTER JOIN  (
		...
		WHERE ENDED BETWEEN '2014-11-01' and '2014-12-12'
